...
export function InterviewSetup({
    ...
    // 滑块已选部分填充青色的比例
    const sliderPercent = ((maxQuestions - 3) / (10 - 3)) * 100;
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-4">
                        <input
                            ...
                            className="flex-1 interview-question-range"
                            style={{ background: `linear-gradient(to right, #0d9488 ${sliderPercent}%, #e5e7eb ${sliderPercent}%)` }}
                        />
