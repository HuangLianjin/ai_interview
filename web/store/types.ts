...
const SERVER_DEFAULT_MODEL: ModelConfig = {
    id: 'server-deepseek',
    name: 'DeepSeek（服务器默认）',
    provider: 'deepseek',
    apiKey: '',
...
export const DEFAULT_API_CONFIG: ApiConfig = {
    models: [SERVER_DEFAULT_MODEL],
    smartModelId: SERVER_DEFAULT_MODEL.id,
    fastModelId: SERVER_DEFAULT_MODEL.id,
    generalModelId: SERVER_DEFAULT_MODEL.id,
    matchAnalystModelId: SERVER_DEFAULT_MODEL.id,
    contentWriterModelId: SERVER_DEFAULT_MODEL.id,
    hrReviewerModelId: SERVER_DEFAULT_MODEL.id,
    reflectorModelId: SERVER_DEFAULT_MODEL.id,
    voiceModelId: '',
};
