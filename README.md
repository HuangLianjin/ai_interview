...
- 演示地址：https://interview.1624899.fun
- 演示环境可直接注册体验，验证码会显示在接口返回中。

---
## 📖 项目简介

职面 AI是一个利用大语言模型（LLM）和 LangGraph 状态机技术构建的综合求职辅助系统。它不仅能进行全真模拟面试，还能像专业的职业咨询师一样，通过多智能体协作（Multi-Agent）对简历进行深度诊断和定向优化，帮助求职者全方位提升竞争力。现已上线测试：[职面 AI](https://interview.1624899.fun)
